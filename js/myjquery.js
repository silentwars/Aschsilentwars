...
function Gundong(){
  ...
  heighttime=new Date("2016,8,19"),
  Heighttime=parseInt(((curtime.getTime()-heighttime.getTime())/1000)),
  lefttime=parseInt(((endtime.getTime()-curtime.getTime())/1000)),
  d=parseInt(lefttime/(60*60*24)),
  h=parseInt(lefttime/(60*60)%24),
  m=parseInt(lefttime/60%60),
  t=parseInt(Heighttime/10)-3268,
  s=parseInt(lefttime%60);
  m=checked(m);
  s=checked(s);
  var downtime=$('#downtime');
  var chain_height=$('#chain_height');
